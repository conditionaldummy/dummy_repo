...
Note that these experiments took around 24 hours to run on GPU. To increase speed, consider reducing the size of the compressed set generated, or the size of the target dataset, $M$ and $N$ respectively.
