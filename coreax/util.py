...
def pairwise_tuple(
    ...
    [
        tuple[
            Union[Shaped[Array, "n d"], Shaped[Array, " d"], Shaped[Array, ""]],
            Union[Shaped[Array, "n p"], Shaped[Array, " p"], Shaped[Array, ""]],
        ],
        tuple[
            Union[Shaped[Array, "m d"], Shaped[Array, " d"], Shaped[Array, ""]],
            Union[Shaped[Array, "m p"], Shaped[Array, " p"], Shaped[Array, ""]],
        ],
    ],
    Shaped[Array, " n m"],
]:
...
def geodesic_distance(
    ...
    """
    Calculate the geodesic distance between two vectors.
    ...
    # Ensure we are on the unit hypersphere
    x /= jnp.linalg.norm(x)
    y /= jnp.linalg.norm(y)

    # Clip to avoid floating point errors
    return jnp.arccos(jnp.clip(jnp.dot(x, y), -1, 1))
