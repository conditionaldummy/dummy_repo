...
class TestTensorProductKernel:
    ...
    feature_kernel: ScalarValuedKernel = SquaredExponentialKernel()
    response_kernel: ScalarValuedKernel = LinearKernel()
    ...
    def test_compute_elementwise_calls_sub_kernels_correctly(self) -> None:
        ...
        k1, k2 = MagicMock(spec=ScalarValuedKernel), MagicMock(spec=ScalarValuedKernel)
